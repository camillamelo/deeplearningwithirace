...
if __name__ == "__main__":
    ...
    storage = JournalStorage(JournalFileStorage("optuna-journal7.log"))
    #get date and time
    #now = datetime.now()
    #date_time = now.strftime("%Y-%m-%d-%H-%M-%S")

    study_name = "Experiment7"
    ...
    #study.optimize(objective, timeout=367444, n_jobs=2)
    #para terminar após erro
    study.optimize(objective, timeout=50007, n_jobs=2)
